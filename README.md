...
After that, there are a set of kernel options required by tinyboot, listed [here](./doc/required.config), and optionally [here](./doc/required-64bit.config) for 64-bit platforms. For more information, see the [documentation](./doc/kernel-configuration.md).
