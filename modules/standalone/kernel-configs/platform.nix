  ...
  linux.kconfig = lib.mkIf (config.platform != null) (
    with lib.kernel;
    {
      ...
      "mediatek" = {
        ...
        PWM_CROS_EC = yes;
        PWM_MTK_DISP = yes;
        REGULATOR_MT6311 = yes;
        REGULATOR_MT6315 = yes;
        REGULATOR_MT6323 = yes;
        REGULATOR_MT6331 = yes;
        REGULATOR_MT6332 = yes;
        REGULATOR_MT6357 = yes;
        REGULATOR_MT6358 = yes;
        REGULATOR_MT6359 = yes;
        REGULATOR_MT6360 = yes;
        REGULATOR_MT6370 = yes;
