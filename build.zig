...
pub fn build(b: *std.Build) !void {
    ...
    // TODO(jared): get this compiling for non-linux targets
    ...
    // tboot-bless-boot, tboot-bless-boot-generator, and tboot-nixos-install
    // (for nixos machines) run on the machine using tboot-loader, so it
    // doesn't make sense to build for non-linux targets.
